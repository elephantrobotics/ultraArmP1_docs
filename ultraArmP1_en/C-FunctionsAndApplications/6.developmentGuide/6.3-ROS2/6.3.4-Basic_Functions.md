...
It will **open rviz to display the model following effect**. At this point, dragging the joints of the real robotic arm will cause the simulation model to follow the movement of the real robotic arm.
