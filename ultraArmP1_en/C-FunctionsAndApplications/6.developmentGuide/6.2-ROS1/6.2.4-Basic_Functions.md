...
>> **Note: The pymycobot driver library version must be greater than 4.0.5**
...
After successful execution, you need to press and hold the LED button at the end of the machine to drag the joint. The terminal output information is as follows:
...
- In the `sync_plan.py` file, modify the speed parameter of the robotic arm's Python API; here, change it to 25.
