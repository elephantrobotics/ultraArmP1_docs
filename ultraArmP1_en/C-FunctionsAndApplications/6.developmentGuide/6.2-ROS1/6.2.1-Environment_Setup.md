...
> **Built-in Environment:** ROS1 + Moveit + Git + ultraArm_P1_lib + p1_ros
...
<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v1.png
width="500" align="center">

<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/einstallbox.gif
width = "500" align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v3.png
width="500" align="center">

<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v4.png
width="500" align="center">

<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v5.png
width="500" align="center">

<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v6.png
width="500" align="center">

Just wait for the image to be imported. The installation is successful as shown below.

<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v7.png
width="500" align="center">
...
```bash
pip3 install ultraArm_P1_lib --upgrade
```
...
cd ~/catkin_ws/src
# Delete the original p1_ros package
sudo rm -rf p1_ros

git clone --depth 1 https://github.com/elephantrobotics/p1_ros.git
...
<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/installbox-1.png
width="500" align="center">
...
<img src = ../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-1.png width="500" height="300" align="center">

Configure the memory size according to your needs and proceed to the next step.

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-4.png
width ="500" height ="400" align = "center">

- Select **Create a virtual hard disk now** and create it.

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-5.png
width ="500" height ="400" align = "center">

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-7.png
width ="500" height ="300" align = "center">

Select the **VDI** type for the virtual hard disk type and proceed to the next step.

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-6.png
width ="500" height ="400" align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-80.png
align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-1.png
width ="500" align = "center">

After downloading, there is a file as shown in the figure:

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-2.png
width ="500" align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/evbox-2.png
width ="500" align = "center">

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/eros-1.png
width ="500" align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-1.png
width ="500" align = "center">

Click the "Continue" button;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-2.png
width ="500" align = "center">

Select the "Erase the entire disk and install Ubuntu" option, and click the "Install Now" button;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-3.png
width ="500" align = "center">

Click the "Continue" button in the pop-up dialog box;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-4.png
width ="500" align = "center">

Set the geographic location and click the "Continue" button;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-5.png
width ="500" align = "center">

Set the user name and password and click the "Continue" button;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-6.png
width ="500" align = "center">

Enter the system installation interface, please wait patiently;

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-7.png
width ="500" align = "center">

After the installation is complete, in the pop-up dialog box, click the "Restart Now" button to complete the installation.

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/uit-8.png
width ="500" align = "center">
...
For **ultraArm P1** devices, please refer to the installation methods and processes described below. 
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-1.png
width ="500"  align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-2.png
width ="500"  align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-3.png
width ="500"  align = "center">
...
<!-- <img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-4.png
width ="500"  align = "center"> -->
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-5.png
width ="500"  align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ros-6.png
width ="500"  align = "center">
...
<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-git-1.png
width ="500"  align = "center">
...
`p1_ros` is a ROS package launched by ElephantRobotics, which is compatible with its desktop 4-axis robot arm ultraArm series.

项目地址：[http://github.com/elephantrobotics/p1_ros](http://github.com/elephantrobotics/p1_ros)
...
- The interaction between this package and the real robot arm depends on PythonApi - `ultraArm_P1_lib`
- The Api project is: [https://github.com/elephantrobotics/ultraArm_P1_lib](https://github.com/elephantrobotics/ultraArm_P1_lib)
- Quick installation: `pip install ultraArm_P1_lib --upgrade`

When executing the pip install ultraArm_P1_lib --upgrade command, if the following error message appears:

<img src =../../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-ultraArm_P1_lib.png
width ="500" align = "center">
...
git clone --depth 1 https://github.com/elephantrobotics/p1_ros.git # Clone the code on github
cd .. # Return to the workspace
catkin_make # Build the code in the workspace
source devel/setup.bash # Add environment variables
```
