...
**Top Right:** After clicking the button, the viewing center will be quickly positioned to the top left corner of the work area.

<img width = "1200" align = "center" src="../../../resources/C-FunctionsAndApplications/5-BasicApplication/5.3-myStudioPro/scene-10.png" />

**Top Left:** After clicking the button, the viewing center will be quickly positioned to the upper right corner of the work area.
...
Integrated with multi-directional view adjustment buttons (main view, rotation, positioning), users can freely switch the viewing angle and examine the trajectory details from any perspective. 
...
Provide the main view (restore default perspective), rotate left/rotate right/rotate up/rotate down (adjust the viewing angle), and left upper point/right upper point (quickly position the view center to the upper left corner or upper right corner of the work area), facilitating multi-dimensional inspection of the processing trajectory.
