...
- A1: Please refer to the following path. The urdf of all ultraArm P1 models is in this path: https://github.com/elephantrobotics/p1_ros/tree/noetic/p1_description/urdf

**Q2: What is the base coordinate system of the ultraArm P1 robot?**

<img src="../../../resources/2-BasicSettings/3.UserNotice/基坐标系.png"
height = "400" align = "center">

**Q3: Are the joints of the ultraArm P1 controlled by the serial bus?**
...
<img src="../../../resources/2-BasicSettings/3.UserNotice/坐标系.png"
height = "400" align = "center">
...
**Q6: What is the voltage range of the ultraArm P1 power supply? How much is the instantaneous current?**
...
**Q8: Does the ultraArm P1 machine have collision detection?**

A8:ultraArm P1 has algorithmic collision self-interference, which has been integrated into the API for setting joint angles and coordinates
...
**Q10: When replacing the second joint of the ultraArm P1, I found that 4 screws were stripped. How to remove them?**
