...
1. The green light around the power button illuminates, indicating that the power supply is working correctly.
2. The MiniRobot screen first displays the Logo for about 3 seconds, then automatically enters the main interface, showing the current joint angles and coordinate information.
