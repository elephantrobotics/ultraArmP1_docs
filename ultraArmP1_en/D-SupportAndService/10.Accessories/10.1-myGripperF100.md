...
| Applicable equipment | ER ER myCobot 320 series, ER Mercury series, ER myCobot Pro 600, ERmyCobot Pro 630, other general robots, ER ultraArm P1 |
...
### Based On ultraArm P1 Terminal IO Control
The IO control method can only control the gripper to fully open and close

```python
from ultraArm_P1_lib import ElephantRobot
import time
...
Connect the 24V, GND, 485_A (T/R+, 485+), 485_B (T/R-, 485-) wires at the end of the gripper, a total of 4 wires, the power supply is a 24V DC regulated power supply or the 24V of the IO at the bottom of the ultraArm P1, insert the USB port of the module into the USB port of the computer
...
24V connects to 24V DC regulated power supply positive pole/24V of IO at the bottom of the ultraArm P1;

GND connected to 24V DC regulated power supply negative pole/GND of IO at the bottom of the ultraArm P1
