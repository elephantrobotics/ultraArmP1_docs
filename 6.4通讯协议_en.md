...
- Speed range: 1-100 (percentage), each 1% corresponds to approximately 1.6°/s
- Motion complete feedback: `EndEnd`
...
Command: `G0`
Parameters: `X` X-axis coordinate(mm), `Y` Y-axis coordinate(mm), `Z` Z-axis coordinate(mm), `R` R-axis angle(°), `F` Speed(1%-100%)
Response: `EndEnd`
...
Command: `G1`
Parameters: `A` J1 joint angle(°), `B` J2 joint angle(°), `C` J3 joint angle(°), `D` J4 joint angle(°), `F` Speed(1%-100%)
Response: `EndEnd`
...
Command: `G1`
Parameters: `A/B/C/D` Target joint angle(°), `F` Speed(1%-100%)
Response: `EndEnd`
Example: `G1 A10 F20`
...
Command: `M19`
Parameters: `J` Joint(1-4), `T` Step value(°), `F` Speed(1%-100%)
Response: `EndEnd`
Example: `M19 J3 T10 F100`
Description: Specified joint moves relative to current position by specified angle increment
- J1 step range: ±(0.1~316)°
- J2 step range: ±(0.1~103)°
- J3 step range: ±(0.1~101)°
- J4 step range: ±(0.1~358)°

#### 9. Coordinate Step Control
Command: `M20`
Parameters: `J` Axis(1-X, 2-Y, 3-Z, 4-Rx), `T` Step value(mm/°), `F` Speed(1%-100%)
Response: `EndEnd`
...
Command: `M46`
Parameters: `X` X-axis coordinate(mm), `Y` Y-axis coordinate(mm), `Z` Z-axis coordinate(mm), `R` R-axis angle(°)
...
Command: `M47`
Parameters: `A` J1 joint angle(°), `B` J2 joint angle(°), `C` J3 joint angle(°), `D` J4 joint angle(°)
...
Response: `EndEnd`
Example: `M30 J1`
Description: Manually move robot to scale mark for joint calibration. Sets J1/J2/J4 current position to 0°, J3 to 90°.
...
Command: `M21`
Parameters: `J` Joint(0-4, 0=all), `P` Threshold(0.5~5°)
...
Command: `M25`
Parameters: `P` Angle(1-100, corresponding to 0.5~50°), `F` Speed(1-100)
...
| Data Length | 1 byte | Data length = 2×N |
| Data | 2×N bytes | Actual data (high byte first) |
...
| Command (Reference Gcode, not Modbus content) | Function Code | Register Address | Data Length | Data Format | Response Length | Response Format | Description |
|---------|---------------|------------------|-------------|-------------|-----------------|-----------------|-------------|
...
| M300 Read | 03 | 00 37 | 6 | byte1:I(0-255), byte2:U(0-255), byte3:L(0-125), byte4-5:H(0-65535), byte6:N(1-255) | 1-255 | byte1~N: Read data (hex) | I2C data read (Note: May return register address 00 36 on error) |
