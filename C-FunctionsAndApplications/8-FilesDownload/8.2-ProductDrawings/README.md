...
产品图纸部分提供了 ultraArm P1 机械臂及其配件的详细 3D 模型文件（STEP 格式）。这些图纸对于需要进行定制化设计、仿真集成或进行维护的工程人员来说尤为重要，可以帮助他们更好地理解机械臂的构造与尺寸。

### 机器 3D 模型

| 机器 | 3D 模型文件 |
| :--: | :--------: |
| ultraArm P1 | [下载](../../resources/C-FunctionsAndApplications/8-FilesDownload/8.2-ProductDrawings/ultraArm_P1%281%29.STEP) |
