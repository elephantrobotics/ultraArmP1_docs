...
PARAMETERS
 * /follow_display/baud: 1000000
 * /follow_display/port: /dev/ttyUSB0
 * /follow_display/publish_rate: 30.0
 * /robot_description: <?xml version="1....
 * /robot_state_publisher/source_list: ['joint_states']
 * /rosdistro: noetic
 * /rosversion: 1.16.0

NODES
  /
    follow_display (ultraarm_p1/follow_display.py)
    robot_state_publisher (robot_state_publisher/robot_state_publisher)
    rviz (rviz/rviz)

auto-starting new master
process[master]: started with pid [107485]
ROS_MASTER_URI=http://localhost:11311

setting /run_id to 6341ca68-7501-11f1-ae28-0779105c1594
process[rosout-1]: started with pid [107498]
started core service [/rosout]
process[follow_display-2]: started with pid [107501]
process[robot_state_publisher-3]: started with pid [107502]
process[rviz-4]: started with pid [107506]
[INFO] [1782878428.562999]: Trying to connect to real ultraArm P1...
[INFO] [1782878428.570972]: port: /dev/ttyUSB0, baud: 1000000

[INFO] [1782878429.701797]: Please press the LED button at the end of the machine to drag the joint.
请按下机器末端LED按钮进行关节拖拽运动

[INFO] [1782878429.706181]: Publishing ...
```
...
`mycobot_ros` 整合了 ultraArm P1 MoveIt 部分。
...
```python
rosrun ultraarm_p1_moveit sync_plan.py _port:=/dev/ttyUSB0 _baud:=1000000 _speed:=25
```

- 在 Moveit RViz 界面中，修改速度和加速度的缩放比例。在这里，将其改为 0.1，然后保存当前配置。`ultraarm_p1_moveit` 功能包默认配置 0.5。
