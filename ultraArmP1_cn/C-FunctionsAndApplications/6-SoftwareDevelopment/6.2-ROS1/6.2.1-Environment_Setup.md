...
<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/installbox.gif
width = "500" align = "center">
...
<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox_install-1.png
width="500" align="center">

<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox_install-2.png
width="500" align="center">

<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox_install-3.png
width="500" align="center">

<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox_install-4.png
width="500" align="center">

等待镜像导入即可，如下图即为安装成功。

<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox_install-5.png
width="500" align="center">
...
<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-1.png width="500" height="300" align="center">

- 按照自己的需求配置内存大小，进行下一步。

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-2.png
width ="500" height ="300" align = "center">

- 选择**现在创建虚拟硬盘**，进行创建。

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-3.png
width ="500" height ="300" align = "center">

 虚拟硬盘类型选择**VDI**类型，进行下一步。

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-4.png
width ="500" height ="300" align = "center">


 分配虚拟硬盘大小，由于需要安装 ubuntu 系统，而且还会在该系统中进行操作，建议大小不要低于 20G。

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-7.png
width ="500" height ="300" align = "center">

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/vbox-8.png
align = "center">
...
<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-3.png
width ="500" align = "center">

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-4.png
width ="500" align = "center">

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-5.png
width ="500" align = "center">
...
<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-6.png
width ="500"  align = "center">

点击“继续”按钮；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-7.png
width ="500"  align = "center">

选中“清除整个磁盘并安装 Ubuntu”选项，点击“现在安装”按钮；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-8.png
width ="500"  align = "center">

在弹出的对话框中点击“继续”按钮；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-9.png
width ="500"  align = "center">

设置地理位置，点击“继续”按钮；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-10.png
width ="500"  align = "center">

设置用户名和密码，点击“继续”按钮；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-11.png
width ="500"  align = "center">

进入系统安装界面，请耐心等待；

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-12.png
width ="500"  align = "center">

待安装完成，在弹出的对话框中，点击“现在重启”按钮，完成安装。

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/u-13.png
width ="500"  align = "center">
...
Ubuntu 本身的软件源列表中没有 ROS 的软件源，所以需要先配置 ROS 的软件源密钥和软件源地址。打开一个控制台终端（快捷键 <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>T</kbd>），输入如下指令：
...
```bash
echo "deb [arch=$(dpkg --print-architecture) signed-by=/usr/share/keyrings/ros-archive-keyring.gpg] http://packages.ros.org/ros/ubuntu $(. /etc/os-release && echo $UBUNTU_CODENAME) main" | sudo tee /etc/apt/sources.list.d/ros1.list > /dev/null
```

- 若下载速度缓慢，推荐使用国内镜像源。例如清华源：

```bash
echo "deb [arch=$(dpkg --print-architecture) signed-by=/usr/share/keyrings/ros-archive-keyring.gpg] https://mirrors.tuna.tsinghua.edu.cn/ros/ubuntu/ $(. /etc/os-release && echo $UBUNTU_CODENAME) main" | sudo tee /etc/apt/sources.list.d/ros1.list > /dev/null
```

**注意：官方源和清华源二选一即可，不要同时添加多个 ROS 源。**
...
>> 注意：ROS Noetic 主要对应 Ubuntu 20.04。如果是 Ubuntu 22.04，建议安装 ROS2 Humble；不要直接用 apt 安装 ROS Noetic。
...
<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/ros-1.png
width ="500"  align = "center">
...
- 快速安装：`pip install pymycobot --upgrade`
  ...
  <img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/install-pymycobot.png
  width ="500"  align = "center">
...
至此 ROS1 环境搭建完成，ROS1 的使用请参考 [ROS基础](./6.2.2-ROS_Basics.md) or [ROS基础功能案例](./6.2.4-Basic_Functions.md)
