...
<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.3-ROS2/rviz2-1.png
...
```bash
ros2 launch ultraarm_p1 test.launch.py
```

打开 rviz2，得到如下结果：

<img src =../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.3-ROS2/rviz2-2.png
width ="1200"  align = "center">
