...
<img src = ../../../resources/C-FunctionsAndApplications/6-SoftwareDevelopment/6.2-ROS1/v2.gif
width = "500" align = "center">
...
Ubuntu 本身的软件源列表中没有 ROS2 的软件源，所以需要先配置 ROS2 的软件源密钥和软件源地址。打开一个控制台终端（快捷键 <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>T</kbd>），输入如下指令：
...
**注意：官方源、清华源、中科大源三选一即可，不要同时添加多个 ROS2 源。**
...
**Ubuntu 20.04 更常用 Foxy，Ubuntu 22.04 更常用 Humble；Galactic 已经过了维护期，不建议新装。**
