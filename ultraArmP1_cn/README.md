...
本框架沿用450 gitbook框架，内含不符合P1的文件夹或内容，可去除重写。

在文档编写过程需依据以下规则：
1、编写完文件后必须先合并至gitbook-cn-new，再由产品助理检查后统一合并至主支。
...
例如：5.2.1章节的内容所引用的图片资源放在ultraArmP1_cn\C-FunctionsAndApplications\5-BasicApplication\5.2-minirobot目录下，不再往下新建细分图片资源的目录。
 ...
 [下一章 →](../ultraArmP1_cn/1-ProductInformation/1-ProductIntroduction/1-ProductIntroduction.md)
